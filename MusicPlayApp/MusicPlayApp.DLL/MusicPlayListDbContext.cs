...
namespace MusicPlayApp.DLL
{
    public partial class MusicPlayListDbContext : DbContext
    {
        ...
        public virtual DbSet<PlaylistSong> PlaylistSongs { get; set; } // Đảm bảo DbSet cho PlaylistSongs
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Playlist>(entity =>
            {
                ...
                // Thiết lập nhiều-nhiều giữa Playlist và Song qua PlaylistSongs
                entity.HasMany(d => d.Songs).WithMany(p => p.Playlists)
                    .UsingEntity<PlaylistSong>(
                        ...
                        j =>
                        {
                            j.HasKey(ps => new { ps.PlaylistId, ps.SongId }).HasName("PK__Playlist__D22F5AC91C42137E");
